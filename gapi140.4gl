...
# Modify.........: NO:FUN-D70109 13/07/24 By qirl 匯出excel
# Modify.........: NO:TQC-D70098 13/07/30 By yinhy 修改時，如果直接從第二行數量跳到第一行在修改，此時价g_rvw17還保留第二行的值
# Modify.........: NO:FUN-D70121 13/08/06 By qirl 會計年期會不按照自然年月設置，需要按照aooq011的設置來
# Modify.........: NO:TQC-D90025 13/09/24 By yuhuabao 由於aapp111中刪除了apa15/apa16的傳參獲取，調用的參數需要調整
# Modify.........: NO:TQC-DA0007 13/10/14 By zhangweib 手工可以錄入驗退單不會卡控
# Modify.........: NO:FUN-DA0132 13/11/01 By wangrr 增加"拋轉帳款還原"功能
# Modify.........: No.MOD-DC0088 13/12/12 By yinhy 賬款編號rvw18不為空，不可刪除
# Modify.........: No.MOD-DC0120 13/12/19 By yuhuabao 調整AFTER FIELD rvw07 報錯-239段，新增或者修改rvw07的情況下才需要此重複性檢查
# Modify.........: No.MOD-E30117 14/03/18 By yinhy 賬款編號rvw18不為空，也不可更改
# Modify.........: No.CHI-E30018 14/03/24 By yihsuan FUNCTION i140_var_process 中判斷 g_head_1.rvw05f_sum<>g_head_1.rvw05f_s 
#                                                    再增加 OR g_head_1.rvw06f_s != g_head_t.rvw06f_s
# Modify.........: No.MOD-E90013 14/09/04 By doris FUNCTION i140_undo_carry_account 參考 saapt110 刪除段處理 apv_file 動作
# Modify.........: No.CHI-EA0009 14/10/16 By Hungli 資料清單取得資料的時間點，只需在按下【資料清單】頁簽時，不在按上下筆的時候呼叫                        
# Modify.........: No.CHI-EB0021 14/11/28 By doris 調整未稅金額、含稅金額、稅額的計算規則 
# Modify.........: No.MOD-F10069 15/01/19 By doris 帳款還原時,如為兩者類型時,倉退更新 rvv23 異常
# Modify.........: No.MOD-F10140 15/01/29 By doris CALL s_compute_amt 增加參數傳入 未稅金額(rvv39)
# Modify.........: No.MOD-F40062 15/04/16 By doris AFTER FIELD rvw05f 段1.如rvw05f新舊值不同,則不CALL s_compute_amt,2.rvw05f金額改動後重新計算rvw06f/rvw05/rvw06/sum1/sum2
#                                                  3.其餘 CALL s_compute_amt前應先判斷新舊值不同再呼叫
# Modify.........: No.FUN-E10053 15/05/12 By doris 單身增加規格(ima021)欄位呈現
# Modify.........: No.CHI-F80014 15/09/01 By fionchen 調整CURSOR在二次查詢顯示異常的問題 
# Modify.........: No.MOD-FC0154 15/12/28 By doris rvw07增加tis-001控卡,並調整取l_n之SQL
# Modify.........: No.MOD-G40106 16/04/27 By catmoon CALL s_compute_amt 增加參數傳入rvv01(單號)、rvv02(項次)
# Modify.........: No.MOD-G50168 16/06/02 By edison i140_b及i140_r函式中 RETURN 前加上CLOSE CURSOR
# Modify.........: No.MOD-G60044 16/06/08 By edison 修正資料拋轉帳款後，不得修改單身資料
# Modify.........: No.06100389_M001_7_1 23/12/28 By DSC.ANHDUY add column MGD色號 pmnud02,品名 ima02a,規格 ima021a
...
DEFINE
   ...
   g_type        LIKE type_file.chr1,         # Prog. Version..: '5.30.23-16.12.05(01)   #類型
   ...
   g_rvw         DYNAMIC ARRAY OF RECORD                 #程式變數(Program Variables)
                 ...
                 ima021     LIKE ima_file.ima021,        #規格   #FUN-E10053 add
                 pmnud02    LIKE pmn_file.pmnud02,       #MGD色號 #06100389_M001_7_1 add
                 ima02a     LIKE ima_file.ima02,         #品名    #06100389_M001_7_1 add
                 ima021a    LIKE ima_file.ima021,        #規格    #06100389_M001_7_1 add
...
DEFINE g_bookno11       LIKE aza_file.aza81  #FUN-D70121 add
DEFINE g_bookno21       LIKE aza_file.aza82  #FUN-D70121 add
         ...
         WHEN "Input_Invoice_By_No"
            ...
            ELSE
               ...
               IF NOT cl_null(g_head_1.rvw01) THEN
                  ...
                  EXIT PROGRAM
               END IF
              #CALL i140_list_fill()  #FUN-CB0080  #CHI-EA0009 mark
...
#                 LET g_cmd = "aapp111 '' '3' '4' '' '",g_head_1.rvw19,"' '' '' '",g_user,"' '",g_clas,"' '' 'N' '",g_head_1.rvw01,"'" #No.FUN-CB0053 Add #TQC-D90025 mark
                  LET g_cmd = "aapp111 '' '3' '4' '' '",g_head_1.rvw19,"' '",g_user,"' '",g_clas,"' '' 'N' '",g_head_1.rvw01,"'"  #TQC-D90025 add
                 #CALL cl_cmdrun(g_cmd)       #No.FUN-CB053   Mark
                  CALL cl_cmdrun_wait(g_cmd)  #No.FUN-CB0053  Add
                  SELECT rvw18 INTO g_head_1.rvw18 FROM rvw_file WHERE rvw01 = g_head_1.rvw01   #No.FUN-CB0053 Add
               END IF
        ...
        #FUN-DA0132--add--str--
        WHEN "undo_carry_account" 
         IF cl_chk_act_auth() THEN
            CALL i140_undo_carry_account()
         END IF 
        #FUN-DA0132--add--end
...
DEFINE
  #l_sql           LIKE type_file.chr1000,  #NO FUN-690009 VARCHAR(300)   #MOD-E90013 mark
   l_sql           STRING,                                                #MOD-E90013 add
...
DEFINE l_pmm02     LIKE pmm_file.pmm02      #MOD-C90185 add
  ...
  #---MOD-G60044---add---str---
   IF NOT cl_null(g_head_1.rvw07) THEN
      SELECT COUNT(*) INTO l_cnt
        FROM rvw_file
       WHERE rvw01 = g_head_1.rvw01
         AND rvw07 = g_head_1.rvw07
         AND (rvw18 IS NOT NULL OR rvw18 <> ' ')
   ELSE
      SELECT COUNT(*) INTO l_cnt
        FROM rvw_file
       WHERE rvw01 = g_head_1.rvw01
 ...
 # LET g_forupd_sql = "SELECT rvw99,rvw08,rvw09,'','',rvw02,rvw10,rvw17,rvw05f,rvw06f,rvw05,rvw06",    #FUN-9B0130 add rvw99  #FUN-C80027 mark
  #LET g_forupd_sql = "SELECT rvw99,rvw08,rvw09,'','',rvw02,rvw10,rvw17,rvw05f,rvw06f,'',rvw05,rvw06,''",    #FUN-C80027 ADD   #FUN-E10053 mark
  #FUN-E10053---add---str--
   LET g_forupd_sql = "SELECT rvw99,rvw08,rvw09,'','', ",
                      "       '','','','',rvw02,rvw10,rvw17,rvw05f, ",  #06100389_M001_7_1 add '','',''
                      "       rvw06f,'',rvw05,rvw06,''",
  #FUN-E10053---add---end--
                      "  FROM rvw_file ",
                      " WHERE rvw01 = ? ",
   ...
   INPUT ARRAY g_rvw WITHOUT DEFAULTS FROM s_rvw.*
            ...
            OPEN i140_bcl USING g_head_1.rvw01,g_rvw_t.rvw08,g_rvw_t.rvw09               #表示更改狀態
               ...
               ELSE
                 ...
                 #CHI-EB0021---add---str---
                  ...
                  DISPLAY BY NAME g_rvw[l_ac].sum1,g_rvw[l_ac].sum2   
                 #CHI-EB0021---add---end---
                 LET g_plant_new = g_rvw[l_ac].rvw99
                 CALL s_gettrandbs()
                 LET li_dbs = g_dbs_tra
                 #LET g_sql = "SELECT rvv09,rvv31,rvv031 FROM ",li_dbs CLIPPED,"rvv_file ",
                #LET g_sql = "SELECT rvv09,rvv31,rvv031 FROM ",cl_get_target_table(g_rvw[l_ac].rvw99,'rvv_file'), #FUN-A50102   #CHI-EB0021 mark
                #CHI-EB0021---add---str---add rvv38,rvv39t
                 LET g_sql = "SELECT rvv09,rvv31,rvv031,rvv38t,rvv39t, ",   #MOD-F10140 add ,
                             "       rvv39 ",                               #MOD-F10140 add 
                             "  FROM ",cl_get_target_table(g_rvw[l_ac].rvw99,'rvv_file'),
                #CHI-EB0021---add---end---
                 ...
                 EXECUTE sel_rvv09_pre INTO g_rvw[l_ac].rvv09,g_rvw[l_ac].ima01,g_rvw[l_ac].ima02,g_rvv38t,g_rvv39t,   #CHI-EB0021 add rvv38t,rvv39t   #MOD-F10140 add ,
                                            g_rvv39                                                                                                    #MOD-F10140 add
                #FUN-E10053---add---str--
                 SELECT ima021 INTO g_rvw[l_ac].ima021
                   FROM ima_file
                  WHERE ima01 = g_rvw[l_ac].ima01
                #FUN-E10053---add---end--
                #06100389_M001_7_1 add --begin--
                SELECT pmnud02 INTO g_rvw[l_ac].pmnud02
                FROM rvv_file,pmn_file
                WHERE rvv36 = pmn01 AND rvv37 = pmn02
                  AND rvv01 = g_rvw[l_ac].rvw08 AND rvv02 = g_rvw[l_ac].rvw09
                IF NOT cl_null(g_rvw[l_ac].pmnud02) THEN
                   SELECT ima02,ima021 INTO g_rvw[l_ac].ima02a,g_rvw[l_ac].ima021a
                   FROM ima_file WHERE ima01 = g_rvw[l_ac].pmnud02
                END IF
                #06100389_M001_7_1 add --end--
               END IF
	  ...
	  #          CALL cl_parse_qry_sql(g_sql,g_plant_new) RETURNING g_sql       #FUN-A50102	            
          ...
          #CHI-EB0021---mark---end---
         #MOD-F40062---add---str--
           IF l_rvw05f_t <> g_rvw[l_ac].rvw05f THEN
              LET g_rvw[l_ac].rvw05f = cl_digcut(g_rvw[l_ac].rvw05f,t_azi04)
              LET g_rvw[l_ac].rvw05  = g_rvw[l_ac].rvw05f * g_head_1.rvw12
         ...
         #MOD-F40062---mark---str--
         ##CHI-EB0021---add---str---
         # LET g_sql = "SELECT rvv03 FROM ",cl_get_target_table(g_plant_new,'rvv_file'), 
         #             " WHERE rvv01 = '",g_rvw[l_ac].rvw08,"' ",
         #             "   AND rvv02 = '",g_rvw[l_ac].rvw09,"' "
         ...
         # PREPARE sel_rvv03_pre FROM g_sql
         # EXECUTE sel_rvv03_pre INTO l_rvv03
         # CALL s_compute_amt(g_rvw[l_ac].rvw10,g_rvw[l_ac].rvw17,g_rvv38t,g_rvv39,g_rvv39t,   #MOD-F10140 add g_rvv39
         #                    g_head_1.rvw04,g_gec05,g_gec07,g_head_1.rvw12,g_flag,
         #                    g_type,l_rvv03)
         #          RETURNING g_rvw[l_ac].rvw05f,g_rvw[l_ac].rvw06f,g_rvw[l_ac].rvw05,g_rvw[l_ac].rvw06,g_rvw[l_ac].sum1,g_rvw[l_ac].sum2
         ##CHI-EB0021---add---end---
         #MOD-F40062---mark---end--
            #MOD-B70073--end 
      ...
      AFTER FIELD rvw10
         ...
         ELSE
           ...
           #CHI-EB0021---add---str---
            ...
            CALL cl_parse_qry_sql(g_sql,g_plant_new) RETURNING g_sql      
            PREPARE sel_gec07_pre1 FROM g_sql
            EXECUTE sel_gec07_pre1 INTO g_gec05,g_gec07   
           #CHI-EB0021---add---end---
            IF g_rvw[l_ac].rvw10 <> 0 AND (l_rvw10_t <> g_rvw[l_ac].rvw10            #No.MOD-940412
               OR g_rvw_t.rvw05f <> g_rvw[l_ac].rvw05f) THEN   #No.MOD-910073
               LET g_flag = 'N'                                #MOD-A80052
	      ...
	      #            CALL cl_parse_qry_sql(g_sql,g_plant_new) RETURNING g_sql       #FUN-A50102            
              ...
              #   #不含稅
              #   #未稅金額=未稅單價*數量
              #   LET g_rvw[l_ac].rvw05f = g_rvw[l_ac].rvw17*g_rvw[l_ac].rvw10                  #原幣稅前  #MOD-CA0222 mark
              #   #LET g_rvw[l_ac].rvw05f = g_rvw17*g_rvw[l_ac].rvw10                  #No.MOD-CA0222  #TQC-D70098
              #CHI-EB0021---mark---end---
            END IF   
           #CHI-EB0021---mark---str---
           #IF g_type = '3' AND g_rvw[l_ac].rvw05f > 0 THEN                 #負值顯示
	   ...
	   #               CALL cl_parse_qry_sql(g_sql,g_plant_new) RETURNING g_sql       #FUN-A50102            
           ...
           #CHI-EB0021---mark---end---
           #CHI-EB0021---add---str---
            IF l_rvw10_t <> g_rvw[l_ac].rvw10 THEN   #MOD-F40062 add
               CALL s_compute_amt(g_rvw[l_ac].rvw10,g_rvw[l_ac].rvw17,g_rvv38t,g_rvv39,g_rvv39t,   #MOD-F10140 add g_rvv39
                                  g_head_1.rvw04,g_gec05,g_gec07,g_head_1.rvw12,g_flag,
                                 #g_type,l_rvv03)                                     #MOD-G40106 mark
                                  g_type,l_rvv03,g_rvw[l_ac].rvw08,g_rvw[l_ac].rvw09) #MOD-G40106 add
                        RETURNING g_rvw[l_ac].rvw05f,g_rvw[l_ac].rvw06f,g_rvw[l_ac].rvw05,g_rvw[l_ac].rvw06,g_rvw[l_ac].sum1,g_rvw[l_ac].sum2
            END IF                                   #MOD-F40062 add
           #CHI-EB0021---add---end---
            DISPLAY BY NAME g_rvw[l_ac].rvw05
            DISPLAY BY NAME g_rvw[l_ac].rvw06
            DISPLAY BY NAME g_rvw[l_ac].rvw05f
...
#MOD-B70073--mark--end           
      ...
      AFTER FIELD rvw17
         IF NOT cl_null(g_rvw[l_ac].rvw17) THEN
            IF cl_null(g_rvw[l_ac].rvw05f) OR g_rvw[l_ac].rvw05f=0 OR l_rvw17_t <> g_rvw[l_ac].rvw17 THEN   
               ...
               #END IF
              #CHI-EB0021---mark---str---
              #   LET g_rvw[l_ac].rvw05f = g_rvw[l_ac].rvw17*g_rvw[l_ac].rvw10      #MOD-CA0222 mark   #TQC-D70098
              #   #LET g_rvw[l_ac].rvw05f = g_rvw17*g_rvw[l_ac].rvw10                 #MOD-CA0222      #TQC-D70098
              #CHI-EB0021---mark---end---
            END IF
           #CHI-EB0021---mark---str---      
           #IF g_type = '3' AND g_rvw[l_ac].rvw05f > 0 THEN                 #負值顯示
	   ...
	   #               CALL cl_parse_qry_sql(g_sql,g_plant_new) RETURNING g_sql                      
           ...
           #CHI-EB0021---mark---end---
           #CHI-EB0021---add---str---
            IF l_rvw17_t <> g_rvw[l_ac].rvw17 THEN   #MOD-F40062 add
               CALL s_compute_amt(g_rvw[l_ac].rvw10,g_rvw[l_ac].rvw17,g_rvv38t,g_rvv39,g_rvv39t,   #MOD-F10140 add g_rvv39
                                  g_head_1.rvw04,g_gec05,g_gec07,g_head_1.rvw12,g_flag,
                                 #g_type,l_rvv03)                                     #MOD-G40106 mark
                                  g_type,l_rvv03,g_rvw[l_ac].rvw08,g_rvw[l_ac].rvw09) #MOD-G40106 add 
      ...
      ON ACTION controlp
         CASE
		    ...
		    CALL cl_parse_qry_sql(g_sql,g_plant_new) RETURNING g_sql
                    ...
                    END IF   
                   #end MOD-B50016 add
                    LET g_rvw[l_ac].rvw17 = cl_digcut(g_rvw[l_ac].rvw17,t_azi03)     #210706 dsc.kim add
      ...
      ON ACTION sel_rvv
        #IF cl_null(g_head_1.rvw01) OR cl_null(g_head_1.rvv06) THEN RETURN END IF                  #MOD-G50168 mark
        #---MOD-G50168---add---str---
         IF cl_null(g_head_1.rvw01) OR cl_null(g_head_1.rvv06) THEN
            CLOSE i140_bcl
            RETURN
         END IF
        #---MOD-G50168---add---end---
...
FUNCTION i140_upd_rvb22(p_cmd)                #更新驗收單發票號碼
   DEFINE p_cmd    LIKE type_file.chr1        # Prog. Version..: '5.30.23-16.12.05(01)   #b:單身新增 d:刪除
...
#No.MOD-A20009 --end 
   ...
   DEFINE l_rvu03   LIKE rvu_file.rvu03   #FUN-D70121--add-
...
#No.MOD-A20009 --begin                                                          
  ...
  #FUN-D70021--add--end                                          
  #LET g_sql = "SELECT YEAR(rvu03),MONTH(rvu03) ",     #FUN-D70121--mark--
   LET g_sql = "SELECT rvu03 ",     #FUN-D70121--add--
 ...
 # EXECUTE sel_y_rvu03 INTO l_year,l_month       #FUN-D70121--mark-- 
   EXECUTE sel_y_rvu03 INTO l_rvu03    #FUN-D70121--add-- 
#FUN-D70121--add--star--
    CALL s_get_bookno(YEAR(l_rvu03)) RETURNING g_flag,g_bookno1,g_bookno2
    IF g_flag= '1' THEN
       CALL cl_err(l_rvu03,'aoo-081',1)
    END IF
    LET l_year = s_get_aznn(g_plant,g_bookno1,l_rvu03,1)
    LET l_month = s_get_aznn(g_plant,g_bookno1,l_rvu03,3)
#FUN-D70121--add---end---   
  #FUN-A60056--mod--end
#FUN-D70121--add--star--
    CALL s_get_bookno(YEAR(g_head_1.rvw02)) RETURNING g_flag1,g_bookno11,g_bookno21
    IF g_flag1= '1' THEN
       CALL cl_err(g_head_1.rvw02,'aoo-081',1)
    END IF
#FUN-D70121--add---end--- 
 # IF l_year <> YEAR(g_head_1.rvw02) OR                                 #FUN-D70121--mark-
 #    l_month <> MONTH(g_head_1.rvw02) THEN                             #FUN-D70121--mark-
   IF l_year <> s_get_aznn(g_plant,g_bookno11,g_head_1.rvw02,1) OR       #FUN-D70121--add--
      l_month <> s_get_aznn(g_plant,g_bookno11,g_head_1.rvw02,3) THEN    #FUN-D70121--add--
      LET l_n = 0  
      SELECT COUNT(apa01) INTO l_n FROM apb_file,apa_file,aznn_file     #FUN-D70121--add--aznn_file
   ...
   IF NOT cl_null(g_rvw[l_ac].rvw08) THEN
      SELECT rvv31 INTO l_rvv31 FROM rvv_file
       ...
       IF l_rvv31[1,4] != 'MISC' THEN
        ...
        #EXECUTE sel_rvw09_rvu03 INTO l_year,l_month  #FUN-D70121--mark--
         EXECUTE sel_rvw09_rvu03 INTO l_rvu03           #FUN-D70121--add--
#FUN-D70121--add--star--
          CALL s_get_bookno(YEAR(l_rvu03)) RETURNING g_flag,g_bookno1,g_bookno2
          IF g_flag= '1' THEN
             CALL cl_err(l_rvu03,'aoo-081',1)
...
#FUN-D70121--add---end---
      ...
      #FUN-D70121--add---end---
       ...
       #    l_month <> MONTH(g_head_1.rvw02) THEN                             #FUN-D70121--mark-
         IF l_year <> s_get_aznn(g_plant,g_bookno11,g_head_1.rvw02,1) OR       #FUN-D70121--add--
            l_month <> s_get_aznn(g_plant,g_bookno11,g_head_1.rvw02,3) THEN    #FUN-D70121--add--
            SELECT COUNT(apa01) INTO l_cnt FROM apb_file,apa_file,aznn_file     #FUN-D70121--add--aznn_file
             WHERE apb21 = g_rvw[l_ac].rvw08
              AND apb01 = apa01
         ...
         ELSE
            ...
            ELSE
               LET g_sql = "SELECT rvu03,rvv31,rvv031,rvv87,",
                           ...
                           "       gec05,rvu114,rvb22,rvv39,rvv39t",   #CHI-EB0021 add rvv39t
                           #"  FROM ",li_dbs CLIPPED,"rvv_file,",li_dbs CLIPPED,"rvu_file,",
                           #          li_dbs CLIPPED,"rva_file,",li_dbs CLIPPED,"rvb_file,",
                           #          li_dbs CLIPPED,"gec_file",
                        #FUN-B50019 --begin
               ...
               EXECUTE sel_rvu03_pre2 INTO g_rvw[l_ac].rvv09,g_rvw[l_ac].ima01,
                                           g_rvw[l_ac].ima02,g_rvw[l_ac].rvw10,
                                           l_rvu12,g_rvw[l_ac].rvw17,g_rvw11,g_rvw03,
                                           g_gec05,g_rvw12,g_rvb22,g_rvw[l_ac].rvw05f,g_rvv39t   #CHI-EB0021 add rvv39t
              #FUN-E10053---add---str--
               SELECT ima021 INTO g_rvw[l_ac].ima021
                 FROM ima_file
                WHERE ima01 = g_rvw[l_ac].ima01
      ...
      ELSE
         IF NOT cl_null(l_rvv36) THEN              #FUN-940083--add
            LET g_sql = "SELECT rvu03,rvv31,rvv031,rvv17,",
                        "       gec04,rvv38,pmm20,pmm22,pmm21,",   #CHI-CC0038 add pmm20
                        "       gec05,pmm42,rvb22,rvv39,rvv39t",   #CHI-EB0021 add rvv39t
                        #"  FROM ",li_dbs CLIPPED,"rvv_file,",li_dbs CLIPPED,"rvu_file,",
                        #          li_dbs CLIPPED,"rvb_file,",li_dbs CLIPPED,"pmm_file,",
                        #          li_dbs CLIPPED,"gec_file",
                        "  FROM ",cl_get_target_table(g_plant_new,'rvv_file'),",", #FUN-A50102
            ...
            EXECUTE sel_rvu03_pre3 INTO g_rvw[l_ac].rvv09,g_rvw[l_ac].ima01,
                                        ...
                                        g_rvw03,g_gec05,g_rvw12,g_rvb22,g_rvw[l_ac].rvw05f,g_rvv39t   #CHI-EB0021 add rvv39t
           #FUN-E10053---add---str--
            SELECT ima021 INTO g_rvw[l_ac].ima021
              FROM ima_file
             WHERE ima01 = g_rvw[l_ac].ima01
         ...
         ELSE
            IF NOT cl_null(l_rvv04) THEN
               LET g_sql = "SELECT rvu03,rvv31,rvv031,rvv17,",
                           "       gec04,rvv38,rva113,rva115,",
                           "       gec05,rva114,rvb22,rvv39,rvv39t",   #CHI-EB0021 add rvv39t
                           #"  FROM ",li_dbs CLIPPED,"rvv_file,",li_dbs CLIPPED,"rvu_file,",
...
#                    "   AND rvu00 = '3'   AND rvv89 <> 'Y'"    #只抓退貨單資料     #No.MOD-A70133 mark
      ...
      #No.CHI-CC0038  --End  
      LET g_rvw04=l_rvu12
      LET g_rvv39 = g_rvw[l_ac].rvw05f   #MOD-F10140 add 
...
#  END IF                          #No.MOD-A70133  mark
  ...
  ##LET g_rvw17 = g_rvw[l_ac].rvw17                                 #No.MOD-CA0222  #TQC-D70098
  ##LET g_rvw[l_ac].rvw17 = cl_digcut(g_rvw[l_ac].rvw17,t_azi04)    #No.MOD-CA0222 #MOD-CB0281 mark
  #LET g_rvw[l_ac].rvw17 = cl_digcut(g_rvw[l_ac].rvw17,t_azi03)    #MOD-CB0281 add
  #CHI-EB0021---mark---end--
  #CHI-EB0021---add---str---
   CALL s_compute_amt(g_rvw[l_ac].rvw10,g_rvw[l_ac].rvw17,g_rvv38t,g_rvw[l_ac].rvw05f,g_rvv39t,   #MOD-F10140 add g_rvw[l_ac].rvw05f 
                      g_head_1.rvw04,g_gec05,g_gec07,g_head_1.rvw12,g_flag,
                     #g_type,l_rvv03)                                     #MOD-G40106 mark
                      g_type,l_rvv03,g_rvw[l_ac].rvw08,g_rvw[l_ac].rvw09) #MOD-G40106 add 
            RETURNING g_rvw[l_ac].rvw05f,g_rvw[l_ac].rvw06f,g_rvw[l_ac].rvw05,g_rvw[l_ac].rvw06,g_rvw[l_ac].sum1,g_rvw[l_ac].sum2
  #CHI-EB0021---add---end---
   ...
   DISPLAY BY NAME g_rvw[l_ac].ima021   #FUN-E10053 add
...
DEFINE
  #l_wc2           LIKE type_file.chr1000,  #NO FUN-690009 VARCHAR(300)   #MOD-E90013 mark
   l_wc2           STRING,                                                #MOD-E90013 add
...
DEFINE
  #p_wc2           LIKE type_file.chr1000  #NO FUN-690009 VARCHAR(200)   #MOD-E90013 mark
   p_wc2           STRING                                                #MOD-E90013 add
...
DEFINE l_rvv36     LIKE rvv_file.rvv36    #06100389_M001_7_1 add
DEFINE l_rvv37     LIKE rvv_file.rvv37    #06100389_M001_7_1 add
   ...
   LET g_sql =
      #   "SELECT rvw99,rvw08,rvw09,'','','',rvw10,rvw17,rvw05f,rvw06f,rvw05,rvw06",   #FUN-9B0130 add rvw99  #FUN-C80027 MARK
         #"SELECT rvw99,rvw08,rvw09,'','','',rvw10,rvw17,rvw05f,rvw06f,'',rvw05,rvw06,''",      #FUN-C80027   #FUN-E10053 mark
         #FUN-E10053---add---str--
          "SELECT rvw99,rvw08,rvw09,'','', ",
          "       '','','','','',rvw10,rvw17,rvw05f, ",     #06100389_M001_7_1 add '','',''
          "       rvw06f,'',rvw05,rvw06,''",
         #FUN-E10053---add---end--
   ...
   FOREACH rvw_curs INTO g_rvw[g_cnt].*            #單身 ARRAY 填充
      ...
      LET g_sql = "SELECT rvv31,rvv031,rvv36,rvv37 FROM ",cl_get_target_table(g_plant_new,'rvv_file'), #FUN-A50102  #06100389_M001_7_1 add rvv36,rvv37
                  " WHERE rvv01 = '",g_rvw[g_cnt].rvw08,"' ",
                  "   AND rvv02 = '",g_rvw[g_cnt].rvw09,"' " 
      CALL cl_replace_sqldb(g_sql) RETURNING g_sql                   #FUN-A50102							
      CALL cl_parse_qry_sql(g_sql,g_plant_new) RETURNING g_sql       #FUN-A50102                              
      PREPARE sel_rvv031 FROM g_sql
      EXECUTE sel_rvv031 INTO g_rvw[g_cnt].ima01,g_rvw[g_cnt].ima02,l_rvv36,l_rvv37     #06100389_M001_7_1 add l_rvv36,l_rvv37
     #FUN-E10053---add---str--
      SELECT ima021 INTO g_rvw[g_cnt].ima021
        FROM ima_file
       WHERE ima01 = g_rvw[g_cnt].ima01
     #FUN-E10053---add---end--
     #06100389_M001_7_1 add --begin--
      SELECT pmnud02 INTO g_rvw[g_cnt].pmnud02
      FROM pmn_file
      WHERE pmn01 = l_rvv36 AND pmn02 = l_rvv37
      IF NOT cl_null(g_rvw[g_cnt].pmnud02) THEN
         SELECT ima02,ima021 INTO g_rvw[g_cnt].ima02a,g_rvw[g_cnt].ima021a
           FROM ima_file
          WHERE ima01 = g_rvw[g_cnt].pmnud02
      END IF
     #06100389_M001_7_1 add --end--
...
DEFINE
   ...
   DISPLAY ARRAY g_rvw TO s_rvw.* ATTRIBUTE(COUNT=g_rec_b,UNBUFFERED)
      ...
      ON ACTION item_list
         LET g_action_choice = "" 
         CALL i140_list_fill() #CHI-EA0009 add
         CALL i140_b_menu()
         CALL cl_set_act_visible("accept,cancel", FALSE)
         LET g_action_choice = "" 
      #FUN-CB0080--add--end   
      ...
      ON ACTION carry_account
         ...
         EXIT DISPLAY
     #FUN-DA0132--add--str--
     ON ACTION undo_carry_account 
        LET g_action_choice= "undo_carry_account"
        EXIT DISPLAY
     #FUN-DA0132--add--end
     #No.FUN-CB0048 ---start--- Add
      ON ACTION gen_da
...
DEFINE  l_cnt   LIKE type_file.num5     #NO FUN-690009 SMALLINT
  ...
  #---MOD-G60044---mark---str---
   #No.MOD-E30117  --Begin
  #SELECT rvw18 INTO g_head_1.rvw18 FROM rvw_file WHERE rvw01 = g_head_1.rvw01
  #IF NOT cl_null(g_head_1.rvw18) THEN
  #     CALL cl_err('','apm-241',0)
  #   RETURN
  #END IF
  ...
  #---MOD-G60044---add---end---
   ...
   ELSE
      FETCH i140_cl INTO
            g_head_1.rvw01,g_head_1.rvw07,g_head_1.rvw02,
            g_head_1.rvw18,g_head_1.rvw19,g_head_1.rvw03,   #No.FUN-CB0053 Add g_head_1.rvw19  #MOD-DC0088 add rvw18
      ...
      AFTER FIELD rvw07
        #MOD-FC0154---add---str--
         IF NOT cl_null(g_head_1.rvw03) THEN
            SELECT gec05 INTO g_gec05
              FROM gec_file
             WHERE gec01 = g_head_1.rvw03
               AND gec011='1'
            IF cl_null(g_head_1.rvw07) AND g_gec05 MATCHES '[SN]' THEN
        ...
        #-----------------------CHI-B30082-----------------(S)
         ELSE
            #MOD-DC0120 ---- add ---- begin
            IF p_cmd = 'a' OR
              (p_cmd = 'u' AND ((g_head_t.rvw07 IS NULL AND NOT cl_null(g_head_1.rvw07))
                            OR  (g_head_t.rvw07 IS NOT NULL AND g_head_t.rvw07 <> g_head_1.rvw07))) THEN
            #MOD-DC0120 ---- add ---- end
               LET l_n = 0 
               IF NOT cl_null(g_head_1.rvw07) THEN   #MOD-FC0154 add 
...
FUNCTION i140_r()
   ...
   ELSE
      ...
      IF SQLCA.sqlcode THEN                                         #資料被他人LOCK
        #CALL cl_err(g_head_1.rvw01,SQLCA.sqlcode,0) RETURN END IF                 #MOD-G50168 mark
     #---MOD-G50168---add---str---
         CALL cl_err(g_head_1.rvw01,SQLCA.sqlcode,0)
         CLOSE i140_cl
         RETURN
...
DEFINE l_sum1       LIKE rvw_file.rvw05f,   #CHI-EB0021 add
       l_sum2       LIKE rvw_file.rvw05     #CHI-EB0021 add
      ...
      IF g_sma.sma116 MATCHES '[13]' THEN
         IF NOT cl_null(l_rvv36) THEN                                             #FUN-940083--add
            LET l_sql="SELECT rvv38,rvv87,rvv39,pmm22,pmm21,gec04,gec05,",   #TQC-6C0126
                      "       rvv03,rvv25,rvv39t",  #No.TQC-760013 add rvv03   #MOD-B50016 add rvv25    #CHI-EB0021 add rvv39t
                     ...
                     ," UNION SELECT rvv38,rvv87,rvv39,'','',rvu12,'',rvv03,rvv25,rvv39t",  #MOD-B50016 add rvv25   #CHI-EB0021 add rvv39t
      ...
      ELSE
         IF NOT cl_null(l_rvv36) THEN                                             #FUN-940083--add
            LET l_sql="SELECT rvv38,rvv17,rvv39,pmm22,pmm21,gec04,gec05,",   #TQC-6C0126
                      "       rvv03,rvv25,rvv39t",  #No.TQC-760013 add rvv03   #MOD-B50016 add rvv25   #add rvv39t
                      ...
                      "   AND pmm01 = pmn01 AND gec01 = pmm21 AND gec011='1' ", #No.TQC-9A0091 mod
                      "   AND rvv89 <>'Y'"                                        #FUN-940083--add
                     ," UNION SELECT rvv38,rvv17,rvv39,'','',rvu12,'',rvv03,rvv25,rvv39t",  #MOD-B50016 add rvv25   #CHI-EB0021 add rvv39t
                      #"  FROM ",li_dbs CLIPPED,"rvu_file,",li_dbs CLIPPED,"rvv_file ",   #FUN-9B0130
                      "  FROM ",cl_get_target_table(g_plant_new,'rvu_file'),",", #FUN-A50102
                                cl_get_target_table(g_plant_new,'rvv_file'),     #FUN-A50102                     
                      " WHERE rvv01 = '", l_rvw.rvw08,"'",                                                                             
   ...
   FOREACH i140_sel_rvb INTO l_rvw.rvw17,l_rvw.rvw10,l_rvw.rvw05f,
                             ...
                             l_rvv25,g_rvv39t                                   #MOD-B50016 add rvv25   #CHI-EB0021 add rvv39t
      IF STATUS THEN
         LET g_errno = 'asf-700' RETURN
      END IF
    ...
    #CHI-EB0021---mark---end---
    #CHI-EB0021---add---str---
      CALL s_compute_amt(l_rvw.rvw10,l_rvw.rvw17,g_rvv38t,l_rvw.rvw05f,g_rvv39t,   #MOD-F10140 add l_rvw.rvw05f 
                         g_head_1.rvw04,g_gec05,g_gec07,g_head_1.rvw12,g_flag,
                        #g_type,l_rvv03)                                     #MOD-G40106 mark
                         g_type,l_rvv03,l_rvw.rvw08,l_rvw.rvw09) #MOD-G40106 add 
               RETURNING l_rvw.rvw05f,l_rvw.rvw06f,l_rvw.rvw05,l_rvw.rvw06,l_sum1,l_sum2
    #CHI-EB0021---add---end---1201-add
...
#----------------------No.MOD-B70210----------------------------START
      ...
      END IF
#----------------------No.MOD-B70210-----------------------------END
      LET l_rvw.rvw17 = cl_digcut(l_rvw.rvw17,t_azi03)     #210706 dsc.kim add
      INSERT INTO rvw_file VALUES (l_rvw.*)
      LET g_rvv39 = l_rvw.rvw05f   #MOD-F10140 add
 
   END FOREACH
END FUNCTION
 
FUNCTION i140_var_process(p_cmd)
DEFINE p_cmd       LIKE type_file.chr1,    # Prog. Version..: '5.30.23-16.12.05(01)  #b:單身 u:單頭修改
   ...
   LET tag=0
  #IF g_head_1.rvw05f_sum<>g_head_1.rvw05f_s THEN                                                #CHI-E30018 mark
   IF g_head_1.rvw05f_sum<>g_head_1.rvw05f_s OR g_head_1.rvw06f_s != g_head_t.rvw06f_s THEN      #CHI-E30018 add
...
#計算未生成請款的入庫數量、衝暫估數量
FUNCTION i140_rvw10()
  #DEFINE l_sql    LIKE type_file.chr1000 #NO FUN-690009 VARCHAR(300)   #MOD-E90013 mark
   DEFINE l_sql    STRING                                               #MOD-E90013 add
...
#                 LET g_cmd = "aapp111 '' '3' '4' '' '",g_head_1.rvw19,"' '' '' '",g_user,"' '",g_clas,"' '' 'N' '",g_head_1.rvw01,"'" #No.FUN-CB0053 Add #TQC-D90025 mark
         ...
         WHEN "exporttoexcel"
          # CALL cl_export_to_excel(ui.Interface.getRootNode(),base.TypeInfo.create(g_rvw),'','')
              ...
              CALL cl_export_to_excel(page,base.TypeInfo.create(g_rvw_1),'','')
              #FUN-D70109--add---end---
...
DEFINE l_rvw01         LIKE rvw_file.rvw01            #CHI-F80014 add
DEFINE l_i             LIKE type_file.num10
 
   CALL g_rvw_1.clear()
   LET l_i = 1
   #FOREACH i140_list_cs INTO g_rvw_1[l_i].*          #CHI-F80014 mark
   FOREACH i140_cs INTO l_rvw01                       #CHI-F80014 add
      IF SQLCA.sqlcode THEN
         CALL cl_err('foreach i140_list_cs',SQLCA.sqlcode,1)
         CONTINUE FOREACH
      END IF
      #CHI-F80014 add start --------------------------
      SELECT rvw01,rvw02,rvw19,rvv06,'',rvw03,rvw04,
             rvw11,SUM(rvw05f),SUM(rvw06),rvw12
        INTO g_rvw_1[l_i].*
        FROM rvw_file,rvv_file
       WHERE rvv01=rvw08 AND rvv02 = rvw09
...
FUNCTION i140_x()
   ...
   ELSE
      FETCH i140_cl INTO
            g_head_1.rvw01,g_head_1.rvw07,g_head_1.rvw02,
            g_head_1.rvw18,g_head_1.rvw19,g_head_1.rvw03,   #MOD-DC0088 add rvw18
   ...
   IF cl_exp(0,0,g_head_1.rvwacti) THEN
     ...
     #CALL i140_list_fill() #CHI-EA0009 mark
    END IF
    CLOSE i140_cl
    COMMIT WORK
...
#FUN-DA0132--add--str--
FUNCTION i140_undo_carry_account()
DEFINE l_apa        RECORD LIKE apa_file.*,
       ...
       l_apa14      LIKE apa_file.apa14,   #MOD-E90013 add
       l_apa41      LIKE apa_file.apa41,
       l_apz27      LIKE apz_file.apz27,
       l_n          LIKE type_file.num5
#MOD-E90013---add---str---
DEFINE l_apv02      LIKE apv_file.apv02
DEFINE l_apv03      LIKE apv_file.apv03
DEFINE l_apv04      LIKE apv_file.apv04
DEFINE l_apv05      LIKE apv_file.apv05
DEFINE g_net        LIKE apv_file.apv04
DEFINE g_amt1f,g_amt2f,g_amt3f,g_amt4f,g_amt5f,g_amt6f  LIKE type_file.num20_6
DEFINE g_amt1,g_amt2,g_amt3,g_amt4,g_amt5,g_amt6        LIKE type_file.num20_6
#MOD-E90013---add---end---

   IF s_shut(0) THEN RETURN END IF
   IF cl_null(g_head_1.rvw01) THEN
      CALL cl_err("",-400,0)
      RETURN
   END IF
   IF cl_null(g_head_1.rvw18) THEN
      CALL cl_err("",'axm-077',0)
      RETURN
   END IF
   
   SELECT * INTO l_apa.* FROM apa_file 
   WHERE apa01=g_head_1.rvw18

   IF l_apa.apa41 = 'Y' THEN
      CALL cl_err(l_apa.apa01,'aap-086',0)
      RETURN
   END IF
 
   IF l_apa.apa63 matches '[Ss1]' THEN   
      CALL cl_err(l_apa.apa01,'mfg3557',0)
      RETURN
   END IF
 
   IF l_apa.apa42 = 'Y' THEN
      CALL cl_err(l_apa.apa01,'aap-165',0)
      RETURN
   END IF
 
   IF l_apa.apa75 = 'Y' THEN
      CALL cl_err('apa75=Y','aap-332',0)
      RETURN
   END IF
 
   IF l_apa.apa55 = '1' AND l_apa.apa35 > 0 AND (l_apa.apa34<=l_apa.apa35) THEN
      CALL cl_err(l_apa.apa01,'aap-172',0)
      RETURN
   END IF
   SELECT apz27 INTO l_apz27 FROM apz_file 
   IF l_apz27 = 'N' THEN
      IF l_apa.apa55 = '1' AND l_apa.apa35 > 0 AND (l_apa.apa34<=l_apa.apa35) THEN
      ...
      END IF
   ELSE
      IF l_apa.apa55 = '1' AND l_apa.apa35 > 0 AND (l_apa.apa73<=0) THEN
         CALL cl_err('unpay<=0','aap-172',0)
         RETURN
      END IF
   END IF
 
   IF NOT cl_null(l_apa.apa44) THEN 
      CALL cl_err(l_apa.apa01,'axm-898',0)
      RETURN
   END IF
   
   IF NOT cl_confirm('arm-012') THEN RETURN END IF
   
   LET g_success = 'Y'
   CALL s_showmsg_init()
   BEGIN WORK
   IF l_apa.apa00[1,1] = '2' AND l_apa.apa58 = '1' THEN
      DECLARE z10_curs CURSOR FOR
       SELECT apk26,apk27 FROM apk_file WHERE apk01 = l_apa.apa01
   ...
   SELECT COUNT(*) INTO l_n FROM apk_file WHERE apk01 = l_apa.apa01
   IF STATUS THEN
      LET l_n = 0
   END IF
   IF cl_null(l_n) THEN
   ...
   IF l_n != 0 THEN
      ...
      IF STATUS THEN
         CALL s_errmsg('',l_apa.apa01,'del apk:',SQLCA.sqlcode,1)
         LET g_success = 'N'
      END IF
   END IF
 
   #若請款單刪除應Check請款折讓單也應刪除
   IF l_apa.apa00[1,1] = '1' THEN
      SELECT COUNT(*) INTO g_cnt FROM apa_file
       WHERE apa08 = l_apa.apa01 AND apa58 = '1'
      IF g_cnt > 0 THEN
   ...
   DELETE FROM apa_file WHERE apa01 = l_apa.apa01
   IF STATUS OR SQLCA.SQLCODE THEN
      CALL s_errmsg('',l_apa.apa01,'del apa:',SQLCA.sqlcode,1)
      LET g_success = 'N'
   END IF
   ...
   DELETE FROM npp_file
    WHERE npp01 = l_apa.apa01
      ...
      AND npp011 = 1
   IF STATUS THEN
      CALL s_errmsg('',l_apa.apa01,'del npp:',STATUS,1)
      LET g_success = 'N'
   END IF
   ...
   DELETE FROM npq_file
    WHERE npq01 = l_apa.apa01
      ...
      AND npq011 = 1
   IF STATUS THEN
      CALL s_errmsg('',l_apa.apa01,'del npq:',STATUS,1)
      LET g_success = 'N'
   END IF
 
   DELETE FROM tic_file WHERE tic04 = l_apa.apa01
   DELETE FROM apd_file WHERE apd01 = l_apa.apa01
   DELETE FROM apc_file WHERE apc01 = l_apa.apa01
   DELETE FROM apx_file WHERE apx01 = l_apa.apa01
   DELETE FROM api_file WHERE api01 = l_apa.apa01
 

   DELETE FROM apg_file WHERE apg01 = l_apa.apa01
   IF STATUS OR SQLCA.SQLCODE THEN
      CALL s_errmsg('','','del apg:',SQLCA.SQLCODE,1)
      LET g_success = 'N'
   END IF

   DECLARE t110_r_cur CURSOR FOR
      SELECT * FROM apb_file
       WHERE apb01 = l_apa.apa01
       ORDER BY apb02
 
   FOREACH t110_r_cur INTO l_apb.*
      IF STATUS THEN
      ...
      DELETE FROM apb_file WHERE apb01 = l_apb.apb01 AND apb02=l_apb.apb02
      IF STATUS OR SQLCA.SQLCODE THEN
         CALL s_errmsg('apb01',l_apa.apa01,'del apb:',SQLCA.sqlcode,1)
         LET g_success = 'N'
      END IF
      
      SELECT COUNT(*) INTO l_n FROM apa_file,apb_file
      WHERE apa01=apb01
      AND apb21=l_apb.apb21 AND apb22=l_apb.apb22
      AND (apa00='16' OR apa00='26')  
      AND apa41 ='Y'    #確認  
      AND apa42 ='N'    #未作廢   
      AND apb37 = l_apb.apb37
      
      #更新請款數量 
     #MOD-F10069---add---str--
      IF l_apb.apb09 < 0 THEN
         LET l_apb.apb09 = l_apb.apb09 * -1
      END IF
     #MOD-F10069---add---end-- 
      IF l_n=0 THEN
        #MOD-F10069---mark---str--
        ...
        #END IF
        #MOD-F10069---mark---end--
         UPDATE rvv_file SET rvv23 = rvv23 - l_apb.apb09 
          WHERE rvv01 = l_apb.apb21  AND rvv02 = l_apb.apb22
         IF STATUS OR SQLCA.sqlerrd[3]=0 THEN 
            LET g_success = 'N'
            LET g_showmsg=l_apb.apb21,"/",l_apb.apb22
            CALL s_errmsg("rvv01,rvv02",g_showmsg,"UPDATE:",SQLCA.sqlcode,1)
         END IF
      ELSE
         UPDATE rvv_file SET rvv23 = (rvv23 - l_apb.apb09),
                             rvv88 = (rvv88 + l_apb.apb09) 
          WHERE rvv01 = l_apb.apb21  AND rvv02 = l_apb.apb22
         IF STATUS OR SQLCA.sqlerrd[3]=0 THEN    
            LET g_success = 'N'
            LET g_showmsg=l_apb.apb21,"/",l_apb.apb22
      ...
      IF l_apa.apa00[1,1]='1' THEN
         CALL i140_upd_rvb06(l_apb.apb04,l_apb.apb05)
      END IF
   END FOREACH

  #MOD-E90013---add---str---
   DECLARE t110_r_cur2 CURSOR WITH HOLD FOR
           SELECT apv02,apv03,apv04,apv05 FROM apv_file WHERE apv01 = l_apa.apa01

   FOREACH t110_r_cur2 INTO l_apv02,l_apv03,l_apv04,l_apv05
      IF STATUS THEN
      ...
      DELETE FROM apv_file WHERE apv01 = l_apa.apa01 AND apv02 = l_apv02
      IF STATUS OR SQLCA.SQLCODE THEN
         LET g_showmsg = l_apa.apa01,'/',l_apv02
         CALL s_errmsg('avp01,apv02',g_showmsg,'del apv',SQLCA.sqlcode,1)
         LET g_success = 'N'
         EXIT FOREACH
      END IF

      IF l_apv03 <> 'DIFF' THEN
        ...
        #成本分攤
         ...
         IF cl_null(g_amt4) THEN
            ...
            LET g_amt4f = 0
         END IF
         SELECT apa14 INTO l_apa14 
           FROM apa_file 
          WHERE apa01 = l_apv03
         LET g_amt4f = g_amt4 / l_apa14
         LET g_amt1f = g_amt1f + g_amt2f + g_amt3f + g_amt4f + g_amt6f 
         LET g_amt1 = g_amt1 + g_amt2 + g_amt3 + g_amt4 + g_amt6
         ...
         LET g_amt1f = g_amt1f + g_amt3f + g_amt2f + g_amt6f 
         LET g_amt1  = g_amt1 + g_amt3 + g_amt2 + g_amt6   
         CALL t110_comp_oox(l_apv03) RETURNING g_net
         UPDATE apc_file 
            SET apc10 =g_amt1f,
                apc11 =g_amt1,
  ...
  #MOD-E90013---add---end---
   ...
   UPDATE rvw_file SET rvw18 = ''
    WHERE rvw18 = l_apa.apa01
    
   UPDATE oft_file SET oft21 = NULL
    WHERE oft21 = l_apa.apa01
   
   LET g_msg = TIME
   INSERT INTO azo_file (azo01,azo02,azo03,azo04,azo05,azo06,azoplant,azolegal) 
   VALUES(g_prog,g_user,g_today,g_msg,l_apa.apa01,'delete',g_plant,g_legal)
   IF g_success='Y' THEN
      CALL cl_flow_notify(l_apa.apa01,'D')
   END IF
   CALL s_showmsg()
   ...
   IF g_success = 'Y' THEN
      COMMIT WORK
      LET g_head_1.rvw18=''
      DISPLAY g_head_1.rvw18 TO rvw18
   ELSE
      ROLLBACK WORK
   END IF
...
FUNCTION i140_upd_rvb06(p_apb04,p_apb05)
   ...
   DEFINE l_qty_rvv88        LIKE apb_file.apb09  
   DEFINE l_qty_rvv23_rvv88  LIKE apb_file.apb09
   DEFINE l_rvb06  LIKE rvb_file.rvb06 
   
   IF cl_null(p_apb04) OR cl_null(p_apb05) THEN
      RETURN
   END IF
   ...
   IF STATUS THEN
      LET g_showmsg=p_apb04,"/",p_apb05,"/","11","/","1"
   ...
   LET l_qty1 = 0
    ...
    UPDATE rvb_file SET rvb06 = l_rvb06
      WHERE rvb01 = p_apb04
        AND rvb02 = p_apb05
    
    IF STATUS OR SQLCA.sqlerrd[3]=0 THEN  
       LET g_showmsg=p_apb04,"/",p_apb05
