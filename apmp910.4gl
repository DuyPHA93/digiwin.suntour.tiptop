...
# Modify.........: No.06100389_M001_1_1 23/12/28 By DSC.ANHDUY add handle for UPDATE pmn_file.pmnud02 (MGD色號)
...
DEFINE
        ...
        g_pnbud02     LIKE pnb_file.pnbud02,# MGD色號     #06100389_M001_1_1 add
        g_pnbud03     LIKE pnb_file.pnbud03,# MGD色號     #06100389_M001_1_1 add
...
DEFINE  l_flag3       LIKE type_file.chr1,    #MOD-9C0158
        ...
        g_change_lang LIKE type_file.chr1,    # Prog. Version..: '5.30.23-16.12.05(01)               #No.FUN-570138 是否有做語言切換
...
FUNCTION p910_tm()
 DEFINE lc_cmd        LIKE type_file.chr1000 #No.FUN-680136 VARCHAR(500)            #No.FUN-570138
   ...
   OPEN WINDOW p910_w WITH FORM "cpm/42f/apmp910"
...
#MOD-B10185 mark --end--
   ...
   DECLARE p910_cur2 CURSOR FOR
                 SELECT pnb07a,pnb07b,pnb04a,pnb041a,
                        ...
                        ,pnb04b,pnbud02,pnbud03       #MOD-730011 modify    #06100389_M001_1_1 add pnbud02,pnbud03
   ...
   FOREACH p910_cur2 INTO g_pnb07a,g_pnb07b,g_pnb04a,g_pnb041a,
                          ...
                          ,g_pnb04b,g_pnbud02,g_pnbud03    #MOD-730011 modify   #06100389_M001_1_1 add g_pnbud02,g_pnbud03
...
#    END CASE   	
    ...
    LET l_pmn.pmn16 = '2'
    LET l_pmn.pmn18 = ''
    LET l_pmn.pmnud02 = g_pnbud03   #06100389_M001_1_1 add
...
{ckp#14}
   IF NOT cl_null(g_pnb87a) AND g_pnb87b != g_pnb87a THEN
      ...
      END IF
   END IF
   #06100389_M001_1_1 add --begin--
   IF NOT cl_null(g_pnbud03) AND g_pnbud02 != g_pnbud03 THEN
      UPDATE pmn_file SET pmnud02 = g_pnbud03    #MGD色號
       WHERE pmn01 = g_pna01
         AND pmn02 = g_pnb03       # 採購單項次
 
      IF SQLCA.SQLERRD[3] = 0 THEN
         LET g_success = 'N'
         CALL cl_err3("upd","pmn_file",g_pna01,g_pnb03,"apm-957","","(apmp910:pnbud03)",1)  #No.FUN-660129
         RETURN
      END IF
   END IF
   #06100389_M001_1_1 add --end--
