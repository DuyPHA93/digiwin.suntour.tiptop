# Prog. Version..: '5.30.23-16.12.05(00000)'     #
#
...
# Modify.........: No:SR20171115          By  xie 可以變更單價
# Modify.........: No:06100389_M001_1 23/12/26 DSC.ANHDUY add fields pnbud02,pnbud03
DATABASE ds
...
DEFINE
    ...
    g_pnb           DYNAMIC ARRAY OF RECORD     #程式變數(Program Variables)
        ...
        pnbud02     LIKE pnb_file.pnbud02,      #MGD color no.      #06100389_M001_1 add
        ima02_b     LIKE ima_file.ima02,        #Color name         #06100389_M001_1 add
        ima021_b    LIKE ima_file.ima021,       #Specification      #06100389_M001_1 add
...
#FUN-A80142 --end--        
        ...
        pnbud03     LIKE pnb_file.pnbud03, #MGD color no.      #06100389_M001_1 add
        ima02_a     LIKE ima_file.ima02,   #Color name         #06100389_M001_1 add
        ima021_a    LIKE ima_file.ima021,  #Specification      #06100389_M001_1 add
...
DEFINE  lc_qbe_sn       LIKE    gbm_file.gbm01    #No.FUN-580031  HCN
 ...
 #MOD-4A0252幣別.付款條件.送貨地址.價格條件.發票地址開窗
       ...
       CONSTRUCT g_wc2 ON pnb03,
                          pnb04b,pnb041b,pnbud02,                  #CHI-C50063 add  #06100389_M001_1 add pnbud02
                          pnb20b,pnb07b,pnb31b,pnb32b,  #CHI-C50063 add
                          pnb34b,pnb35b,pnb36b,                    #FUN-A80142       
                          pnb33b,pnb90,pnb91,pnb04a,pnb041a,pnbud03,  #CHI-C50063 add   #06100389_M001_1 add pnbud03
       ...
       FROM s_pnb[1].pnb03,
            ...
            s_pnb[1].pnbud02,                  #06100389_M001_1 add
            ...
            s_pnb[1].pnbud03,                                                 #06100389_M001_1 add
...
#FUN-A80142 --end--
             #CHI-C50063------add------S
              ...
              WHEN INFIELD(pnb04a)
                   ...
                   NEXT FIELD pnb04a
              #06100389_M001_1 add --begin--
              WHEN INFIELD(pnbud02)
                   CALL cl_init_qry_var()
                   LET g_qryparam.state = "c"
                   LET g_qryparam.form = "q_ima"
                   CALL cl_create_qry() RETURNING g_qryparam.multiret
                   DISPLAY g_qryparam.multiret TO pnbud02
                   NEXT FIELD pnbud02
              WHEN INFIELD(pnbud03)
                   CALL cl_init_qry_var()
                   LET g_qryparam.state = "c"
                   LET g_qryparam.form = "q_ima"
                   CALL cl_create_qry() RETURNING g_qryparam.multiret
                   DISPLAY g_qryparam.multiret TO pnbud03
                   NEXT FIELD pnbud03
...
#MOD-B30413 add --end--
 ...
 #MOD-G70039 add end   ------------------
 DEFINE l_pnbud02   LIKE pnb_file.pnbud02 #06100389_M001_1 add  
 DEFINE l_pnbud03   LIKE pnb_file.pnbud03 #06100389_M001_1 add
                    ...
                    IF cl_confirm('apm-543') THEN
                      ...
                      FOREACH upd_pnb_cs INTO l_pnb01,l_pnb02,l_pnb03,l_pnb04a,l_pnb04b,l_pnb20a,l_pnb20b,l_pnb07a,l_pnb07b,l_pnb86a,l_pnb86b 
                         ...
                         IF cl_null(l_pnb04a) THEN
                            ...
                            IF NOT cl_null(l_pnbud02) THEN LET l_pnb04 = l_pnbud02 END IF   #06100389_M001_1 add
                         ELSE
                            LET l_pnb04 = l_pnb04a
                            IF NOT cl_null(l_pnbud03) THEN LET l_pnb04 = l_pnbud03 END IF   #06100389_M001_1 add
                         END IF
...
DEFINE
    ...
    l_newline       LIKE type_file.chr1,    # Prog. Version..: '5.30.23-16.12.05(01)   #Y:為新的項次 No:7629
...
DEFINE  l_itemno_a  LIKE pnb_file.pnb041a   #06100389_M001_1 add
DEFINE  l_itemno_b  LIKE pnb_file.pnb041a   #06100389_M001_1 add
    ...
    CALL cl_opmsg('b')
    LET g_forupd_sql =
      " SELECT pnb03,'0','',0,'',pnb04b,pnb041b,' ',pnbud02,' ',' ',pnb20b,pnb07b,pnb83b,pnb84b,pnb85b,",             #FUN-690129 add pnb90,pnb91   #06100389_M001_1 add pnbud02,' ',' '
      ...
      "              '1',pnb90,pnb91,'',pnb04a,pnb041a,' ',pnbud03,' ',' ',pnb20a,pnb07a,pnb83a,pnb84a,pnb85a,",       #FUN-690129 add pnb90,pnb91 #No.FUN-870117   #06100389_M001_1 add pnbud03,' ',' '
        ...
        BEFORE ROW
		  ...
		  #MOD-6C0095..............end
		    ...
		    END IF
                    ...
                    #06100389_M001_1 add --begin--
                    SELECT ima02,ima021 INTO g_pnb[l_ac].ima02_a,g_pnb[l_ac].ima021_a FROM ima_file
                     WHERE ima01=g_pnb[l_ac].pnbud03
                    SELECT ima02,ima021 INTO g_pnb[l_ac].ima02_b,g_pnb[l_ac].ima021_b FROM ima_file
                     WHERE ima01=g_pnb[l_ac].pnbud02
                    DISPLAY BY NAME g_pnb[l_ac].ima02_a,g_pnb[l_ac].ima021_a
                    DISPLAY BY NAME g_pnb[l_ac].ima02_b,g_pnb[l_ac].ima021_b
                    #06100389_M001_1 add --end--
        ...
        AFTER INSERT
           ...
           #END IF                                         #MOD-9C0280  #MOD-F70041 mark
            ...
            INSERT INTO pnb_file(pnb01,pnb02,pnb03,
                                 ...
                                 pnb34a,pnb34b,pnb35a,pnb35b,pnb36a,pnb36b,pnbud02,pnbud03)     #06100389_M001_1 add pnbud02,pnbud03                         
            ...
            VALUES(g_pna.pna01,g_pna.pna02, g_pnb[l_ac].pnb03,
                  ...
                  ,g_pnb[l_ac].pnbud02,g_pnb[l_ac].pnbud03      #06100389_M001_1 add
                   )
       ...
       BEFORE FIELD pnb04a
            ...
            IF g_cnt = 0 THEN
              ...
              IF g_sma.sma32 <>'Y' THEN  #FUN-690129 #不是請採購勾稽的
                ...
                LET g_pnb[l_ac].pnb041b=''
                LET g_pnb[l_ac].ima021b=''
                LET g_pnb[l_ac].pnbud02=''       #06100389_M001_1 add
                LET g_pnb[l_ac].ima02_b=''       #06100389_M001_1 add
                LET g_pnb[l_ac].ima021_b=''      #06100389_M001_1 add
               #LET g_pnb[l_ac].pnb20b=0 #CHI-B40018 mark 
               #LET g_pnb[l_ac].pnb31b=0 #CHI-B40018 mark
               ...
               #LET g_pnb[l_ac].totb  =0 #CHI-B40018 mark
                ...
                DISPLAY BY NAME g_pnb[l_ac].pnb041b
                DISPLAY BY NAME g_pnb[l_ac].ima021b
                DISPLAY BY NAME g_pnb[l_ac].pnbud02     #06100389_M001_1 add
                DISPLAY BY NAME g_pnb[l_ac].ima02_b     #06100389_M001_1 add
                DISPLAY BY NAME g_pnb[l_ac].ima021_b    #06100389_M001_1 add
                DISPLAY BY NAME g_pnb[l_ac].pnb20b
                DISPLAY BY NAME g_pnb[l_ac].pnb31b
                DISPLAY BY NAME g_pnb[l_ac].pnb33b
                DISPLAY BY NAME g_pnb[l_ac].pnb34b    #FUN-A80142                 
...
#FUN-A80142 --mark--                
            ...
            IF g_sma.sma32='Y' THEN
               ...
               ELSE
                  ...
                  IF cl_null(g_pnb[l_ac].pnb90b) THEN  
                     ...
                     LET g_pnb[l_ac].pnbud02 = g_pnb[l_ac].pnbud03 #06100389_M001_1 add
                  END IF    
               END IF
            END IF
            CALL t910_set_entry_b()
           ...
           #TQC-C50238 -- add -- begin
            IF g_sma.sma32='Y' THEN
               IF l_newline = 'Y' THEN
                  CALL cl_set_comp_entry('pnb04a,pnbua03',TRUE)     #06100389_M001_1 add pnbua03
               ELSE
                  CALL cl_set_comp_entry('pnb04a,pnbua03',FALSE)    #06100389_M001_1 add pnbua03
               END IF
            END IF
           #TQC-C50238 -- add -- end
            CALL t910_check_price() #MOD-D10206 add
...
#FUN-AA0059 ---------------------end-------------------------------
              ...
              IF g_pnb[l_ac].pnb04b != g_pnb[l_ac].pnb04a THEN   #MOD-F30092 add 
                ...
                #CALL s_defprice_new(g_pnb[l_ac].pnb04a,l_pmm09,l_pna08,g_pna.pna04,    #06100389_M001_1 mark
                 CALL s_defprice_new(l_itemno_a,l_pmm09,l_pna08,g_pna.pna04,            #06100389_M001_1 add
        ...
        AFTER FIELD pnbud02
           IF NOT cl_null(g_pnb[l_ac].pnbud02) THEN
              CALL t910_pnbud02(g_pnb[l_ac].pnbud02)
              IF NOT cl_null(g_errno) THEN
                 CALL cl_err(g_pnb[l_ac].pnbud02,g_errno,0)
                 NEXT FIELD pnbud02
              END IF
           END IF
           
        AFTER FIELD pnbud03
           IF NOT cl_null(g_pnb[l_ac].pnbud03) THEN
              CALL t910_pnbud03(g_pnb[l_ac].pnbud03)
              IF NOT cl_null(g_errno) THEN
                 CALL cl_err(g_pnb[l_ac].pnbud03,g_errno,0)
                 NEXT FIELD pnbud03
              END IF
           END IF
           ...
           IF NOT cl_null(g_pnb[l_ac].pnb04a) THEN 
              IF cl_null(g_pnb[l_ac].pnb31a) OR g_pnb[l_ac].pnb31a = 0 THEN 
                 ...
                 IF l_i <=0 THEN  #MOD-B90099
                   ...
                   #CALL s_defprice_new(g_pnb[l_ac].pnb04a,l_pmm09,l_pna08,g_pna.pna04, #MOD-C30904 add ##06100389_M001_1 mark
                    CALL s_defprice_new(l_itemno_a,l_pmm09,l_pna08,g_pna.pna04, #06100389_M001_1 add
            ...
            IF NOT cl_null(g_pnb[l_ac].pnb31a) THEN
               ...
               IF cl_null(g_pnb[l_ac].pnb04a) THEN
                  IF g_sma.sma84 != 99.99 AND g_pnb[l_ac].pnb04b[1,4] <>'MISC' THEN
                     ...
                     END IF  	     
                     #06100389_M001_1 add --begin--
                     IF cl_null(g_pnb[l_ac].pnbud02) THEN
                        LET l_itemno_b = g_pnb[l_ac].pnb04b         #Item no.
                     ELSE LET l_itemno_b = g_pnb[l_ac].pnbud02      #MGD color no.
                     END IF
                     #06100389_M001_1 add --end--
                     ...
                     #FUN-D10004 -- add start --
                      SELECT pmn123 INTO l_pmn123 FROM pmn_file
                       WHERE pmn01 = g_pna.pna01 AND pmn02 = g_pnb[l_ac].pnb03
                     #FUN-D10004 -- add end --
                     #CALL s_defprice_new(g_pnb[l_ac].pnb04b,l_pmm09,l_pna08,g_pna.pna04, #MOD-C30904 add   #06100389_M001_1 mark
                     CALL s_defprice_new(l_itemno_b,l_pmm09,l_pna08,g_pna.pna04,    #06100389_M001_1 add
                                    #l_pnb20,l_task,l_pmm43,l_pmm21,l_type,l_pnb86,'',g_term,g_price,g_plant) #MOD-B30413 mod l_pnb07->l_pnb86 #MOD-BA0204 mark
                                    #l_pnb20,l_task,l_pmm21,l_pmm43,l_type,l_pnb86,'',g_term,g_price,g_plant) #MOD-BA0204 add        #FUN-D10004 mark
                                     l_pnb20,l_task,l_pmm21,l_pmm43,l_type,l_pnb86,'',g_term,g_price,g_plant,l_pmn123)               #FUN-D10004 add
...
#                   CALL cl_create_qry() RETURNING g_pnb[l_ac].pnb04a  #FUN-AB0025 mark
               ...
               #06100389_M001_1 add --begin--
               WHEN INFIELD(pnbud02) #單位
                    CALL cl_init_qry_var()
                    LET g_qryparam.form ="q_ima"
                    LET g_qryparam.where ="imaud10 = '1'"
                    LET g_qryparam.default1 = g_pnb[l_ac].pnbud02
                    CALL cl_create_qry() RETURNING g_pnb[l_ac].pnbud02
                    DISPLAY BY NAME g_pnb[l_ac].pnbud02
                    NEXT FIELD pnbud02
               WHEN INFIELD(pnbud03) #單位
                    CALL cl_init_qry_var()
                    LET g_qryparam.form ="q_ima"
                    LET g_qryparam.where ="imaud10 = '1'"
                    LET g_qryparam.default1 = g_pnb[l_ac].pnbud03
                    CALL cl_create_qry() RETURNING g_pnb[l_ac].pnbud03
                    DISPLAY BY NAME g_pnb[l_ac].pnbud03
                    NEXT FIELD pnbud03
               #06100389_M001_1 add --end--
...
FUNCTION t910_set_entry_b1()
   ...
   DEFINE l_pmm906 LIKE pmm_file.pmm906 #CHI-D30023 add
        ...
        CALL cl_set_comp_entry("pnb90,pnb91,pnb04a,pnbud03,pnb07a,pnb31a,pnb33a,pnb50,pnb80a,pnb86a,pnb87a",TRUE) #CHI-B50016 add   #06100389_M001_1 add pnbud03
       ...
       #CHI-D30023 add start -----
        ...
        IF NOT (l_pmm02 = 'TAP' AND l_pmm906 = 'N' AND NOT cl_null(l_pmm906)) THEN
           CALL cl_set_comp_entry("pnb90,pnb91,pnb04a,pnbud03,pnb20a,pnb07a,                                   pnb86a,pnb87a,pnb34a,pnb35a,pnb36a,                                   pnb33a,pnb50,pnb80a,pnb82a,pnb86a,pnb87a",TRUE)    #06100389_M001_1 add pnbud03
        END IF
       #CHI-D30023 add end   -----
END FUNCTION
...
FUNCTION t910_set_no_entry_b1()
   ...
   DEFINE l_pmn50_55  LIKE pmn_file.pmn50  #MOD-EC0069 add
      ...
      IF g_gec07 = 'N' THEN          
         # CALL cl_set_comp_entry("pnb32a",FALSE) #SR20171115
      ELSE
        # CALL cl_set_comp_entry("pnb31a",FALSE) #SR20171115
      END IF
      ...
      SELECT count(*) INTO l_n
        ...
        IF l_n>0 AND g_sma.sma108 = 'N' THEN           #判斷採購單號已存
          # CALL cl_set_comp_entry("pnb31a,pnb32a",FALSE)    #No.FUN-550089 #SR20171115
        END IF
        #-----MOD-A90171---------
        ...
        IF l_poz00 = '2' AND l_poz011 = '2' THEN 
           ...
           IF l_cnt>0 AND g_sma.sma108 = 'N' THEN 
              #CALL cl_set_comp_entry("pnb31a,pnb32a",FALSE)   #SR20171115
           END IF
        END IF
        #-----END MOD-A90171-----
        IF g_sma.sma32='Y' THEN
        ...
        IF g_blanketpo = 'Y' THEN
          #CALL cl_set_comp_entry("pnb90,pnb91,pnb04a,pnb07a,pnb31a,pnb33a,pnb50,pnb80a,pnb86a,pnb87a",FALSE)    #MOD-G80052 mark 
           CALL cl_set_comp_entry("pnb90,pnb91,pnb04a,pnbud03,pnb07a,pnb33a,pnb50,pnb80a,pnb86a,pnb87a",FALSE)   #MOD-G80052 add    #06100389_M001_1 add pnbud03
        END IF
        #CHI-B50016 add --end--
       ...
       #CHI-D30023 add start -----
        ...
        IF l_pmm02 = 'TAP' AND l_pmm906 = 'N' AND NOT cl_null(l_pmm906) THEN
           CALL cl_set_comp_entry("pnb90,pnb91,pnb04a,pnbud03,pnb20a,pnb07a,                                   pnb86a,pnb87a,pnb34a,pnb35a,pnb36a,                                   pnb33a,pnb50,pnb80a,pnb82a,pnb86a,pnb87a",FALSE)   #06100389_M001_1 add pnbud03
        END IF
       #CHI-D30023 add end   -----
       #MOD-EC0069 add str
...
DEFINE
    ...
    LET g_sql =               #No.FUN-550089
       " SELECT pnb03 ,'0','',0 ,'',pnb04b, pnb041b, ' '    ,pnbud02,' ',' ',pnb20b,pnb07b,pnb83b,pnb84b,",     #06100389_M001_1 add pnbud02,' ',' '
       ...
       "        pnb87b*pnb32b,pnb34b,pnb35b,pnb36b,pnb33b,      ",  #MOD-740032 modify
                   #FUN-A80142 add pnb34b,pnb35b,pnb36b       
       "               '1',pnb90,pnb91 ,'', pnb04a, pnb041a, ' '    ,pnbud03,' ',' ',pnb20a,pnb07a,pnb83a,pnb84a,",  #No.FUN-870117     #06100389_M001_1 add pnbud03,' ',' '
    ...
    FOREACH pnb_cs INTO g_pnb[g_cnt].*   #單身 ARRAY 填充
       ...
       #06100389_M001_1 add --begin--
       SELECT ima02,ima021 INTO g_pnb[g_cnt].ima02_a,g_pnb[g_cnt].ima021_a FROM ima_file
        WHERE ima01=g_pnb[g_cnt].pnbud03
       SELECT ima02,ima021 INTO g_pnb[g_cnt].ima02_b,g_pnb[g_cnt].ima021_b FROM ima_file
        WHERE ima01=g_pnb[g_cnt].pnbud02
       #06100389_M001_1 add --end--
...
DEFINE l_pna02_max  LIKE pna_file.pna02  #CHI-D40033 add
  ...
  # Prog. Version..: '5.30.23-16.12.05(0,0,g_pna.pna05) THEN   #FUN-D20025
...
FUNCTION t910_b_g(p_a,p_ima06,p_pnb33b,p_pnb33a)        #批次變更單身日期展單身資料
   ...
   DEFINE l_pnb DYNAMIC ARRAY OF RECORD
                ...
                pnbud02     LIKE pnb_file.pnbud02,  #06100389_M001_1_1 add
   ...
   CASE p_a
      WHEN "1"  #所有單身日期一併調整
         LET l_sql = " SELECT pmn01, pmn02,  '0',   pmn24,  pmn25,  pmn04, pmn041, pmnud02, pmn20, pmn07, ",    #06100389_M001_1_1 add pmnud02
                     "        pmn83, pmn84,  pmn85, pmn80,  pmn81,  pmn82, pmn86,  pmn87, ",
                     "        pmn31, pmn31t, pmn88, pmn88t, pmn122, pmn96, pmn97,  pmn33 ",
                     "   FROM pmn_file WHERE pmn01 = '",g_pna.pna01,"' "
         IF SQLCA.sqlcode THEN
            CALL s_errmsg('pnb33a',p_pnb33a,"",SQLCA.sqlcode,1)
         END IF
   ...
   FOR l_i = 1 TO l_x
       ...
       LET b_pnb.pnbud02  = l_pnb[l_i].pnbud02      #06100389_M001_1_1 add
...
FUNCTION t910_set_no_entry_b2(p_newline)
  ...
  IF p_newline = 'Y' AND g_sma.sma32='Y'  THEN  
     CALL cl_set_comp_entry("pnb04a,pnbud03",FALSE)     #06100389_M001_1 add pnbud03
  END IF
  #CHI-B50016 add --start--
  IF g_blanketpo = 'Y' THEN
     CALL cl_set_comp_entry("pnb04a,pnbud03",FALSE)     #06100389_M001_1 add pnbud03
...
FUNCTION t910_set_no_required(p_newline)
   ...
   CALL cl_set_comp_required("pnb04a,pnbud03,pnb20a,pnb31a,pnb32a,pnb33a,pnb07a,pnb90,pnb91",FALSE) #No.FUN-550089   #No.TQC-5C0015  #FUN-690129 add pnb90,pnb91    #06100389_M001_1 add pnbud03
...
DEFINE   l_pmn50_55      LIKE pmn_file.pmn50,    #已交量
         ...
         l_i             LIKE type_file.num5,    #No.FUN-680136 SMALLINT
         l_n             LIKE type_file.num5,    #檢查重複用  #No.FUN-680136 SMALLINT
         p_newline       LIKE type_file.chr1,    # Prog. Version..: '5.30.23-16.12.05(01)  #Y:為新的項次 No:7629
         p_cmd           LIKE type_file.chr1     #a:輸入 u:更改  #No.FUN-680136 VARCHAR(1)
DEFINE   l_pml09         LIKE pml_file.pml09     #FUN-690129
...
FUNCTION t910_b_move_back()
   ...
   LET b_pnb.pnbud02  = g_pnb[l_ac].pnbud02     #06100389_M001_1 add
   ...
   LET b_pnb.pnbud03  = g_pnb[l_ac].pnbud03     #06100389_M001_1 add
     ...
     IF g_change = 'Y' THEN
        ...
        IF cl_null(g_pnb[l_ac].pnb04a) THEN  
          #LET g_pnb[l_ac].pnb04a = g_pnb[l_ac].pnb04b #MOD-F70079 mark
           ...
           IF NOT cl_null(g_pnb[l_ac].pnbud02) THEN LET l_pnb04 = g_pnb[l_ac].pnbud02 END IF    #06100389_M001_1 add
        ELSE                                           #MOD-F70079 add
           LET l_pnb04 = g_pnb[l_ac].pnb04a            #MOD-F70079 add
           IF NOT cl_null(g_pnb[l_ac].pnbud03) THEN LET l_pnb04 = g_pnb[l_ac].pnbud03 END IF    #06100389_M001_1 add
        END IF
        IF cl_null(g_pnb[l_ac].pnb87a)  THEN
           LET g_pnb[l_ac].pnb87a = g_pnb[l_ac].pnb87b
  ...
  #MOD-F30092 add end
   ...
   IF l_pnb04[1,4] = 'MISC' AND NOT cl_null(l_pnb04) THEN
      IF g_gec07 = 'Y' THEN   #含稅
       #  CALL cl_set_comp_entry("pnb31a",FALSE) #SR20171115
       #  CALL cl_set_comp_entry("pnb32a",TRUE)  #SR21071115
   ...
   IF g_gec07 = 'Y' THEN   #含稅
      IF l_pnb32 = 0 OR cl_null(l_pnb32) THEN
         ...
         IF l_pnz04 = 'Y' THEN #未取到單價可人工輸入
           ...
           # CALL cl_set_comp_entry("pnb31a",FALSE)  #CHI-EB0018 add #SR20171115
           # CALL cl_set_comp_entry("pnb32a",TRUE)   #CHI-EB0018 add #SR20171115
            LET g_chkpnb31_flag = 'N'
            LET g_chkpnb32_flag = 'Y'
         ELSE
           #CALL cl_set_comp_entry("pmn31",FALSE)   #CHI-EB0018 mark
           ...
           # CALL cl_set_comp_entry("pnb31a",FALSE)  #CHI-EB0018 add   #SR20171115
           # CALL cl_set_comp_entry("pnb32a",FALSE)  #CHI-EB0018 add   #SR20171115
            LET g_chkpnb31_flag = 'N'
            LET g_chkpnb32_flag = 'N'
         END IF
      ELSE
         ...
         IF l_pnz07 = 'Y' THEN   #取到價格可修改
           # CALL cl_set_comp_entry("pnb31a",FALSE)  #SR20171115
           # CALL cl_set_comp_entry("pnb32a",TRUE)    #SR20171115
            LET g_chkpnb31_flag = 'N'
            LET g_chkpnb32_flag = 'Y'
         ELSE
          #  CALL cl_set_comp_entry("pnb31a",FALSE)   #SR20171115
...
#06100389_M001_1 add --begin--
FUNCTION t910_pnbud02(p_pnbud02)
DEFINE
      p_pnbud02  LIKE pnb_file.pnbud02,
     ...
     LET g_errno = ' '
     SELECT ima01,ima02,ima021,imaacti INTO l_ima01,l_ima02,l_ima021,l_imaacti
       FROM ima_file
      WHERE ima01 = p_pnbud02 AND imaud10 = '1'
     CASE
       WHEN SQLCA.SQLCODE = 100 LET g_errno = 'cpm-001'
                                LET l_ima01 = NULL
                                LET l_imaacti = NULL
       WHEN l_imaacti = 'N' LET g_errno = '9028'
       OTHERWISE            LET g_errno = SQLCA.SQLCODE USING '-------'
     ...
     IF cl_null(g_errno) THEN
        LET g_pnb[l_ac].ima02_b = l_ima02
        LET g_pnb[l_ac].ima021_b = l_ima021
        DISPLAY BY NAME g_pnb[l_ac].ima02_b,g_pnb[l_ac].ima021_b
     END IF
END FUNCTION
#06100389_M001_1 add --end--
...
#06100389_M001_1 add --begin--
FUNCTION t910_pnbud03(p_pnbud03)
DEFINE
      p_pnbud03  LIKE pnb_file.pnbud03,
      l_ima01    LIKE ima_file.ima01,
      l_ima02    LIKE ima_file.ima02,
      l_ima021   LIKE ima_file.ima021,
      l_imaacti  LIKE ima_file.imaacti
     ...
     SELECT ima01,ima02,ima021,imaacti INTO l_ima01,l_ima02,l_ima021,l_imaacti
       FROM ima_file
      WHERE ima01 = p_pnbud03 AND imaud10 = '1'
     CASE
       WHEN SQLCA.SQLCODE = 100 LET g_errno = 'cpm-001'
                                LET l_ima01 = NULL
                                LET l_imaacti = NULL
     ...
     IF cl_null(g_errno) THEN
        LET g_pnb[l_ac].ima02_a = l_ima02
        LET g_pnb[l_ac].ima021_a = l_ima021
        DISPLAY BY NAME g_pnb[l_ac].ima02_a,g_pnb[l_ac].ima021_a
     END IF
END FUNCTION
#06100389_M001_1 add --end--
